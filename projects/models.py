...
class Project(models.Model):
    ...
    type = models.CharField(
        choices=ProjectType, default=ProjectType.BACKEND, max_length=10
    )
...
class Issue(models.Model):
    ...
    status = models.CharField(
        choices=IssueStatus, default=IssueStatus.TODO, max_length=20
    )
    priority = models.CharField(
        choices=IssuePriority, default=IssuePriority.HIGH, max_length=20
    )
